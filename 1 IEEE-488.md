...
Most other computers from the early time of home/personal computers had printers connected through either [Centronics](https://en.wikipedia.org/wiki/IEEE_1284) or [RS-232](https://en.wikipedia.org/wiki/RS-232) and disk drives connected directly to the internal bus. For the 1977 [PET](https://en.wikipedia.org/wiki/Commodore_PET), their first computer, Commodore decided to go with a standard interface that would allow to connect several drives and printers to a single port: [IEEE-488](https://en.wikipedia.org/wiki/IEEE-488).
