...
IEEE-488 uses a 24 pin micro ribbon connector, with 16 wires carrying TTL signals:

![](docs/cbmbus/micro_ribbon_24.svg =400x126)

| Pin | Signal | Description        | Pin | Signal | Description        |
|-----|--------|--------------------|-----|--------|--------------------|
| 1   | DIO1   | Data I/O           | 13  | DIO5   | Data I/O           |
| 2   | DIO2   | Data I/O           | 14  | DIO6   | Data I/O           |  
| 3   | DIO3   | Data I/O           | 15  | DIO7   | Data I/O           |
| 4   | DIO4   | Data I/O           | 16  | DIO8   | Data I/O           |
| 5   | EOI    | End Or Identify    | 17  | REN    | Remote Enable      |
| 6   | DAV    | Data Valid         | 18  | GND    |                    |
| 7   | NRFD   | Not Ready For Data | 19  | GND    |                    |
| 8   | NDAC   | No Data Accepted   | 20  | GND    |                    |
| 9   | IFC    | Interface Clear    | 21  | GND    |                    |
| 10  | SRQ    | Service Request    | 22  | GND    |                    |
| 11  | ATN    | Attention          | 23  | GND    |                    |
| 12  | SHIELD |                    | 24  | GND    |                    |     

Every device has just a single micro ribbon connector, but the connectors of IEEE-488 cables have one male and one female side, so the back side of every cable connector becomes the connector to the next device.
