...
Bus arbitration, the logic of designating the sender and the receivers of a transmission, is the job of layer 3, described in Part 2 of this series.

But there is one special case where it is predefined who is the sender and who are the receivers. In this mode, one particiant can start a transmission to **all** other participants at any time.
