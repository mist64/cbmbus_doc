...
Because of this, as well as for compatibility with non-Commodore IEEE-488 devices, timeouts can be globally disabled using the KERNAL call "SETTMO" ($FFA2) with A = $80. On layer 3, this will break "DEVICE NOT PRESENT" and "FILE NOT FOUND" detection for Commodore drives though (see the next article in this series).
